...
\begin{itemize}
    ...
    \item Claude Sonnet 4.5: Selected for its high performance in coding tasks and problem-solving. The more formal tone it tends to use was also found to be beneficial for academic purposes. %todo: add any others
\end{itemize}
