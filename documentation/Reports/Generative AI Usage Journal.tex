...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.8\textwidth]{checklist.png}
...
These 2 prompts illustrate how generative AI was used to structure the report, in accordance with the provided guidelines.
