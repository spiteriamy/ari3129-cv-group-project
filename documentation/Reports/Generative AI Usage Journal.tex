...
This project gave us more exposure to how generative AI can be used as a support tool rather than as a replacement for understanding. A lesson that we learned is that AI is more effective when we already have a foundational understanding of the topic or task. When we asked it for help without fully understanding what we were actually doing, we received answers that may have sounded correct but then actually led to even more errors. This sometimes led to extra time spent debugging or researching to figure out where things went wrong. So in this case, AI did not help us to be more efficient. The usefulness of AI depended on how well we understood what we were trying to do and how carefully we reviewed the output it gave us.

However, generative AI was still particularly helpful for debugging and clarification. When we encountered specific error messages or unexpected behaviour, it was useful for suggesting possible causes or pointing us toward relevant concepts that we might not have thought about. Even when its suggestions were not entirely correct, they often helped us narrow down the problem and encouraged us to think about other options. This made AI a helpful tool for brainstorming.
...
\begin{thebibliography}{99}
    ...
    \bibitem{antigravity}
    Google DeepMind, ``Antigravity: Advanced Agentic Coding Assistant,'' 2026. [Online]. Available: \url{https://antigravity.google/}
